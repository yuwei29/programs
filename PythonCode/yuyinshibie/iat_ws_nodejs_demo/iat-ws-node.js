...
const config = {
  ...
  appid: "387127ab",
  //在控制台-我的应用-语音听写（流式版）获取
  apiSecret: "YTRlOTU5M2M4MjMyYzQ1N2JiZWE4MDY2",
  //在控制台-我的应用-语音听写（流式版）获取
  apiKey: "2afe5a19de2e68685a033c192fbdcf86",
  file: "./16k_10.pcm",//"D:/personal/programs/PythonCode/yuyinshibie/untitled.mp3",// //请填写您的音频文件路径
  uri: "/v2/iat",
  highWaterMark: 1280
}
